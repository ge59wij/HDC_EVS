...
data_dir = '/space/chair-nas/tosy/customdownsampled/train'
...
def test_dataset():
    """
    Tests the EventGestureDataset to ensure it works.
    """
...
def test_label_recognition():
    """
    Tests if the dataset correctly identifies labeled gestures.
    """
    # Check first few samples for label validity
    print(f"Dataset size: {len(dataset)}")
