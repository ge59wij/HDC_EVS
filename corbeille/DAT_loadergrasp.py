...
into a structured format suitable for encoding. It also filters relevant events
using (.npy) labels to extract only the necessary data for gesture classification.
### Features:
